...
- (void)drawRect:(CGRect)rect
{
    ...
    [signPath moveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.53 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.07 * CGRectGetHeight(frame))];
    [signPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.62 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.12 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.53 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.07 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.55 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.12 * CGRectGetHeight(frame))];
    [signPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.72 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.07 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.7 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.12 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.72 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.07 * CGRectGetHeight(frame))];
    [signPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.82 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.12 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.72 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.07 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.75 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.12 * CGRectGetHeight(frame))];
    [signPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.93 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.07 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.9 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.12 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.93 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.07 * CGRectGetHeight(frame))];
    [signPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.97 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.25 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.93 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.07 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.97 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.15 * CGRectGetHeight(frame))];
    [signPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.72 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.47 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.97 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.35 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.85 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.47 * CGRectGetHeight(frame))];
    [signPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.47 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.25 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.6 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.47 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.47 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.35 * CGRectGetHeight(frame))];
    [signPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.53 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.07 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.47 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.15 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.53 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.07 * CGRectGetHeight(frame))];
    [signPath closePath];

    UIBezierPath* bottomOfSignPath = [UIBezierPath bezierPathWithRect: CGRectMake(CGRectGetMinX(frame) + floor(CGRectGetWidth(frame) * 0.4), CGRectGetMinY(frame) + floor(CGRectGetHeight(frame) * 0.2), floor(CGRectGetWidth(frame) * 0.6), floor(CGRectGetHeight(frame) * 0.33))];
    UIBezierPath* topOfSignPath = [UIBezierPath bezierPathWithRect: CGRectMake(CGRectGetMinX(frame) + floor(CGRectGetWidth(frame) * 0.4), CGRectGetMinY(frame) + floor(CGRectGetHeight(frame) * 0.07), floor(CGRectGetWidth(frame) * 0.6), floor(CGRectGetHeight(frame) * 0.12))];
