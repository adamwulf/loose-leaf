           ...
           [UIView animateWithDuration:0.2
                            ...
                            animations:^{
                                if(([setOfPagesBeingPanned count] > 1 && !nonTopPageWillExitBezel)){
                                    ...
                                    for(MMPaperView* page in [[[visibleStackHolder.subviews copy] autorelease] reverseObjectEnumerator]){
...
-(void) emptyBezelStackToHiddenStackAnimated:(BOOL)animated onComplete:(void(^)(BOOL finished))completionBlock{
    ...
    if(animated){
        ...
        for(MMPaperView* page in [[[bezelStackHolder.subviews copy] autorelease] reverseObjectEnumerator]){
