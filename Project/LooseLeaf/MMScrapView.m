...
-(id) initWithScrapViewState:(MMScrapViewState*)_scrapState andPaperState:(MMScrapsOnPaperState*)paperState{
    ...
    if(scrapState.bezierPath){
        if(self = [self initWithBezierPath:scrapState.bezierPath andUUID:scrapState.uuid andPaperState:paperState]){
            // noop
        }
        return self;
    }
...
- (id)initWithBezierPath:(UIBezierPath *)path andPaperState:(MMScrapsOnPaperState*)paperState{
    return [self initWithBezierPath:path andUUID:[NSString createStringUUID] andPaperState:paperState];
}

/**
 * returns a new and loaded scrap with the specified path at the specified scale and rotation.
 *
 * NOTE: the path is owned by this init method and will be modified
 */
-(id)initWithBezierPath:(UIBezierPath *)path andScale:(CGFloat)_scale andRotation:(CGFloat)_rotation andPaperState:(MMScrapsOnPaperState*)paperState{
    ...
    if(self = [self initWithBezierPath:path andUUID:[NSString createStringUUID] andPaperState:paperState]){
 ...
 */
- (id)initWithBezierPath:(UIBezierPath*)_path andUUID:(NSString*)_uuid andPaperState:(MMScrapsOnPaperState*)paperState{
    ...
    if(!scrapState){
        ...
        scrapState = [[MMScrapViewState alloc] initWithUUID:_uuid andBezierPath:originalPath andPaperState:paperState];
        scrapState.delegate = self;
    }
