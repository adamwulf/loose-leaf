 ...
 */
-(id)initWithBezierPath:(UIBezierPath *)path andScale:(CGFloat)_scale andRotation:(CGFloat)_rotation{
    ...
    if(self = [self initWithBezierPath:path andUUID:[NSString createStringUUID]]){
