//
//  MMObjectSelectLongPressGestureRecognizer.h
//  Loose Leaf
//
...
/**
 *
 * This class, along with MMImmovableTapGestureRecognizer, are used to select
 * objects on a page.
 *
 ...
 * too much.
 *
 * this class and MMImmovableTapGestureRecognizer both add checks for the touches themselves
