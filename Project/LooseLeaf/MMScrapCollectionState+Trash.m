//
//  MMScrapCollectionState+Trash.m
//  LooseLeaf
//
...
@implementation MMScrapCollectionState (Trash)
...
+(void)load{
    @autoreleasepool {
        NSError *error = nil;
        [MMScrapCollectionState jr_swizzleMethod:@selector(hasEditsToSave)
                                      withMethod:@selector(swizzle_hasEditsToSave)
                                           error:&error];
        [MMScrapCollectionState jr_swizzleMethod:@selector(dealloc)
