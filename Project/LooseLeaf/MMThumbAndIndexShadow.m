...
-(void) initPaths{
    ...
    [closedPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.19029 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.37189 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.29665 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.44297 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.19515 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.37560 * CGRectGetHeight(frame))];
    [closedPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.15518 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.33893 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.18542 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.36818 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.15738 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.35185 * CGRectGetHeight(frame))];
    [closedPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.17152 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.31522 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.15298 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.32602 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.17152 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.31522 * CGRectGetHeight(frame))];
    [closedPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.17465 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.24902 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.17152 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.31522 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.17245 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.25356 * CGRectGetHeight(frame))];
